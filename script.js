    ...
    recognition.onerror = (event) => {
        ...
        switch (event.error) {
            ...
            case "service-not-allowed":
                errorMessage = "The voice assistant recognition feature is not supported by Instagram browser. For company searches use your keyboard, or Please visit helloblue.ai";
                break;
            default:
                break;
        }
