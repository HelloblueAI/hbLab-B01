...
h1           { font-size: 36px; margin: 0 0 0.3em; }
...
h2           { font-size: 16px; margin: 1.3em 0 0.0; padding: 9px;
               background-color: #11557C; color: white; }
h2 em, h3 em { font-style: normal; color: #A5D6D9; font-weight: normal; }

div.traceback, div.plain { border: 1px solid #ddd; margin: 0 0 1em; padding: 10px; }
div.plain p      { margin: 0; }

div.plain textarea,
div.plain pre { margin: 10px 0 0; padding: 4px;
                background-color: #E8EFF0; border: 1px solid #D3E7E9; }
div.plain textarea { width: 99%; height: 300px; }
div.traceback h3 { font-size: 1em; margin: 0 0 0.8em; }
div.traceback ul { list-style: none; margin: 0; padding: 0 0 0 1em; }
div.traceback h4 { font-size: 13px; font-weight: normal; margin: 0.7em 0 0.1em; }
...
div.traceback blockquote { margin: 1em 0 0; padding: 0; white-space: pre-line; }
...
pre.console { border: 1px solid #ccc; background: white!important;
              ...
              margin: 3px 0 0!important; cursor: default!important;
...
pre.console div.traceback h3 { margin: -10px -10px 10px; padding: 5px;
                               background: #11557C; color: white; }

pre.console div.traceback pre:hover { cursor: default; background: #E8EFF0; }

pre.console div.traceback pre.syntaxerror { border: none;
...
div.traceback pre, div.console pre {       /* css-3 should we be so lucky... */
